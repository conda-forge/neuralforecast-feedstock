...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/neuralforecast-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/neuralforecast-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add neuralforecast
# for installing globally
pixi global install neuralforecast
```
...
It is possible to list all of the versions of `neuralforecast` available on your platform:
...
```
pixi search neuralforecast --channel conda-forge
```
