...
Once the `conda-forge` channel has been enabled, `neuralforecast` can be installed with:

```
conda install neuralforecast
```

It is possible to list all of the versions of `neuralforecast` available on your platform with:
